...
const char srcEth[] = "\x50\x50\x50\x50\x50\x10";
int 
main(int argc, char *argv[])
{
    ...
    // includes Eth header
    // sends frame to host 1 through stack1 router
    char frame[] = {    "\x10\x10\x10\x10\x10\x10"  // |        Destination ETH Address          |
                        ...
                        "\x10\x02\x24\x7f" // | Time to Live  | Protocol  | Header Checksum       |
                        "\xcd\xaf\x35\x35" // |     Source Address          | 
